    ...
    <footer className="mt-auto border-t border-slate-200 bg-ink text-slate-300">
      <div className="mx-auto max-w-6xl px-4 py-12">
        <div className="grid gap-8 md:grid-cols-5">
          ...
          <div>
            <h3 className="mb-3 font-semibold text-white">Guias</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/chip-internacional" className="hover:text-primary">Chip internacional</Link></li>
              <li><Link href="/comparativo-chip-viagem" className="hover:text-primary">Comparativo</Link></li>
              <li><Link href="/quantos-gb-preciso" className="hover:text-primary">Quantos GB preciso</Link></li>
              <li><Link href="/esim-brasil" className="hover:text-primary">eSIM no Brasil</Link></li>
            </ul>
          </div>
          <div>
