...
export function WhatsAppFloatButton({ whatsappNumber }: WhatsAppFloatButtonProps) {
  ...
  async function handleClick() {
    try {
      ...
      // não bloqueia abertura do WhatsApp
    }
  }
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition hover:scale-105 hover:shadow-xl"
